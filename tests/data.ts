module.exports.testData = [
    {
        ...
        out: {
            $: ['2025-03-29T12:00:00.000Z', 'sourceMatchWho', 'sourceMatchId', 'winner', 'points',
                'clubId', 'numFrames', 'startedAt', 'groupPos', 'wins', 'loser', 'details', 'tableNo', 'endedAt', 'players', 'referee', 'bonus'],
            d: {
                tournaments: [
                    {
                        ...
                        id: 35,
                        phases: {
                            $: 0, groupName: ['A', 'OITAVAS'], phase: [1, 3], '§5': [3, 3],
                            matches: [{
                                $: 0,
                                id: [1, 3, 5],
                                '§6': [5, 5, 5],
                                '§11': [null, { '§3': { '§16': 3, '§8': 1 } }, { '§3': { '§8': 2 } }],
                                eta: ['§0', '§0', '§0'], '§12': [1, 1, 1], '§5': [3, 3, 3],
                                '§7': ['2025-03-29T12:03:38.000Z', '2025-03-29T13:05:06.000Z', '2025-03-29T14:59:10.000Z'],
                                '§13': ['2025-03-29T13:04:43.000Z', '2025-03-29T14:37:25.000Z', '2025-03-29T15:50:29.000Z'],
                                '§14': [
                                    { $: 0, pk: [12973, 12972], id: [111, 330], '§9': [3, 0], wo: [false, false], '§4': [3, 0] },
                                    {
                                        $: 0, pk: [12978, 12979], id: [111, 115], '§9': [1, 3],
                                        wo: [false, false], '§2': [1, 2], '§1': ['§3', '§3'], '§4': [1, 6]
                                    },
                                    {
                                        $: 0, pk: [12984, 12985], id: [111, 330], '§9': [3, 0],
                                        wo: [false, false], '§2': [3, 4], '§1': ['§10', '§3'], '§4': [3, 0]
                                    }],
                                '§15': [
                                    { pk: 12974, id: null, wo: false }, { pk: 12980, id: 262, wo: false, '§2': 2, '§1': '§10' },
                                    { pk: 12986, id: 262, wo: false, '§2': 4, '§1': '§10' }]
                            }, [
                                {
                                    id: 54, '§6': 5, '§11': { '§3': { '§16': 2 } },
                                    eta: null, '§12': null, '§5': 3, '§7': '2025-03-29T18:01:38.000Z', '§13': '2025-03-29T20:03:37.000Z',
                                    '§14': {
                                        $: 0, pk: [13123, 13124], id: [111, 116], '§9': [2, 3],
                                        wo: [false, false], '§2': [5, 23], '§1': ['§3', '§3'], '§4': [2, 5]
                                    },
                                    '§15': { pk: null, id: null, wo: null }
                                }]]
                        }
                    }]
            }
